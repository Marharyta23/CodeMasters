                        ...
                        <li key={waterRecord._id} className={css.dailyInfo__listItem}>
                            <div className={css.dailyInfo__leftContainer}>
                                ...
                                <div className={css.dailyInfo__dataContainer}>
                                    <span className={css.dailyInfo__water}>{waterRecord.amountWater} ml</span>
                                    <span className={css.dailyInfo__time}>{formattedTime}</span>
                                </div>
                            </div>
                            <div className={css.dailyInfo__rightContainer}>
                                <button className={css.dailyInfo__iconButton} onClick={() => showModal("WaterModalEdit")}>
                                    <FaEdit />
                                </button>
                                <button className={css.dailyInfo__iconButton} onClick={() => showModal("DeleteWaterModal")}>
                                    <FaTrash />
                                </button>
                            </div>
                        </li>
